...
MODEL_PATH = "lightgbm_model.pkl"       # Adjust path if needed
ENCODER_PATH = "label_encoder.pkl"        # Adjust path if needed
...
def get_top_batsmen_stats():
    try:
        ...
        batsman_stats['Strike_Rate'] = batsman_stats['Strike_Rate'].fillna(0)  # Handle divide by zero if Balls_Faced is 0
